...
<html lang="en">
<head>
    <base href="/public/colorlib-regform-7/">
    <meta charset="UTF-8">
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="../../index.php?c=signup" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="sdt" id="name" placeholder="Phone number"/>
                            </div>
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                    ...
                    <div class="signup-image">
                        ...
                        <a href="../../index.php?c=login" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
        </section>  
