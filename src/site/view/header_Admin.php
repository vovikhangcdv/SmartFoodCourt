    ...
    <div class="c-wrapper c-fixed-components">
        <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
            ...
            <li class="c-header-nav-item dropdown d-md-down-none mx-2 show"><a class="c-header-nav-link" data-toggle="dropdown"  role="button" aria-haspopup="true" aria-expanded="true">
                    ...
                    <form action="<?= PATH_INDEX ?>" method="GET" id='header_read_message'>
                ...
                <li class="c-header-nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right pt-0">
                        ...
                        <a class="dropdown-item" href="<?= PATH_INDEX ?>?c=info&id=<?= $header['user']['id']?>">
                        ...
                        <a class="dropdown-item" href="<?= PATH_INDEX ?>?c=logout">
